...
// lockHeader 标注 lock 由工具生成、不应手改（对齐 package-lock.json 的约定）。
const lockHeader = "# Auto-generated by goxctl-claude. DO NOT EDIT.\n"

// SaveLock 将 lock 写入指定路径。
func SaveLock(path string, l *Lock) error {
	body, err := marshalYAML(l)
	if err != nil {
		return err
	}
	data := append([]byte(lockHeader), body...)
